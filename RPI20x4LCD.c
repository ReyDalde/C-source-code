...
int main()   {
  ...
  while (1)   {
    ...
    ClrLcd();
    lcdLoc(LINE1);
    LCDdisplayStr("Using wiringPi");
    lcdLoc(LINE2);
    LCDdisplayStr("Geany editor.");
    lcdLoc(LINE3);
    LCDdisplayStr("With 20x4 LCD");
    lcdLoc(LINE4);
    LCDdisplayStr("Sample Program.");
    ...
    lcdLoc(LINE1);
    LCDdisplayStr("I2C  Programmed");
    lcdLoc(LINE2);
    LCDdisplayStr("in C language");
    lcdLoc(LINE3);
    LCDdisplayStr(asctime (timeinfo));
    lcdLoc(LINE4);
    LCDdisplayStr("");
    ...
    lcdLoc(LINE1);
    LCDdisplayStr("System temperature:");
    lcdLoc(LINE2);
    for (i=0;i++;i<20) buf[i]=0;
    gcvt(millideg / 1000.00, 20, buf);
    LCDdisplayStr(buf);
    delay(3000);
